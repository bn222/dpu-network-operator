...
func (r *DpuClusterConfigReconciler) ReconcileDpuClusterConfig(ctx context.Context, req ctrl.Request, ovnkubeConfig *dpuv1alpha1.DpuClusterConfig) (ctrl.Result, error) {
	defer func() {
	...
	if err := r.validateDPUHostBootstrap(ovnkubeConfig); err != nil {
		logger.Error(err, "Error while validating OVNKubeConfig")
		return ctrl.Result{}, err
	}
	if err := r.ensureMcpReady(ovnkubeConfig); err != nil {
		logger.Error(err, "Failed to get Mcp into ready state ")
		return ctrl.Result{}, err
	}
	if err := r.validateTenantClusterConfig(ovnkubeConfig); err != nil {
		logger.Error(err, "kubeconfig of tenant cluster is not provided")
		return ctrl.Result{}, err
	}
	if err := r.ensureTenantObjsSynced(ctx, req, ovnkubeConfig); err != nil {
		logger.Error(err, "Failed to sync tenant objects")
		return ctrl.Result{}, err
	}
	if err := r.ensureDeamonSetRunning(ctx, req, ovnkubeConfig); err != nil {
...
func (r *DpuClusterConfigReconciler) ensureMcpReady(ovnkubeConfig *dpuv1alpha1.DpuClusterConfig) error {
	if err := r.syncMachineConfigObjs(ovnkubeConfig.Spec); err != nil {
		ovnkubeConfig.SetStatus(*api.Conditions().NotMcpReady().Reason(api.ReasonFailedCreated).Msg(err.Error()).Build())
		return err
	}
	ovnkubeConfig.SetStatus(*api.Conditions().McpReady().Reason(api.ReasonCreated).Build())
	return nil
}

func (r *DpuClusterConfigReconciler) ensureTenantObjsSynced(ctx context.Context, req ctrl.Request, ovnkubeConfig *dpuv1alpha1.DpuClusterConfig) error {
	if err := r.startTenantSyncerIfNeeded(ctx, ovnkubeConfig); err != nil {
		ovnkubeConfig.SetStatus(*api.Conditions().NotTenantObjsSynced().Reason(api.ReasonFailedStart).Msg(err.Error()).Build())
		return err
	}
	if err := r.isTenantObjsSynced(ctx, req.Namespace); err != nil {
		ovnkubeConfig.SetStatus(*api.Conditions().NotTenantObjsSynced().Reason(api.ReasonNotFound).Msg(err.Error()).Build())
		return err
	}
	ovnkubeConfig.SetStatus(*api.Conditions().TenantObjsSynced().Reason(api.ReasonCreated).Build())
	return nil
}

func (r *DpuClusterConfigReconciler) ensureDeamonSetRunning(ctx context.Context, req ctrl.Request, ovnkubeConfig *dpuv1alpha1.DpuClusterConfig) error {
	if err := r.syncOvnkubeDaemonSet(ctx, ovnkubeConfig); err != nil {
		ovnkubeConfig.SetStatus(*api.Conditions().NotOvnKubeReady().Reason(api.ReasonFailedCreated).Msg(err.Error()).Build())
		return err
	}
    if err := r.checkDeamonSetState(ctx, req, ovnkubeConfig); err != nil {
		ovnkubeConfig.SetStatus(*api.Conditions().NotOvnKubeReady().Reason(api.ReasonProgressing).Msg(err.Error()).Build())
		return err
	}
	ovnkubeConfig.SetStatus(*api.Conditions().OvnKubeReady().Reason(api.ReasonCreated).Build())
    return nil
}

func (r *DpuClusterConfigReconciler) checkDeamonSetState(ctx context.Context, req ctrl.Request, ovnkubeConfig *dpuv1alpha1.DpuClusterConfig) error {
	ds := appsv1.DaemonSet{}
...
func (r *DpuClusterConfigReconciler) validateDPUHostBootstrap(ovnkubeConfig *dpuv1alpha1.DpuClusterConfig) error {
...
func (r *DpuClusterConfigReconciler) validateTenantClusterConfig(ovnkubeConfig *dpuv1alpha1.DpuClusterConfig) error {
